...
DROP TABLE IF EXISTS parsed_disclosure_file CASCADE;
...
-- 공시 파일 파싱 결과
CREATE TABLE parsed_disclosure_file (
    id                       BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    company_id               BIGINT NOT NULL,
    disclosure_file_id       BIGINT NOT NULL UNIQUE,
    company_overview         TEXT,
    business_contents        TEXT,
...
ALTER TABLE parsed_disclosure_file
    ADD CONSTRAINT fk_parsed_disclosure_file_company
        FOREIGN KEY (company_id) REFERENCES company (id);
...
ALTER TABLE parsed_disclosure_file
    ADD CONSTRAINT fk_parsed_disclosure_file_disclosure_file
        FOREIGN KEY (disclosure_file_id) REFERENCES disclosure_file (id);
...
CREATE INDEX idx_parsed_disclosure_file_company ON parsed_disclosure_file (company_id);
